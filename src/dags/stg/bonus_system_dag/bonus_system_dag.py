...
from stg.bonus_system_dag.events_loader import EventsLoader
...
def stg_bonus_system_dag():
    ...
    start_dag >> [ranks_dict, users_dict, events_dict]  # type: ignore


stg_bonus_system_ranks_dag = stg_bonus_system_dag()
